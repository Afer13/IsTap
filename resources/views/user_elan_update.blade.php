        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="apply_job_form white-bg">
                    ...
                    <form action="{{route('elan.user.update')}}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{ $elan->id }}">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="kateqoriya_id">
                                        ...
                                        @foreach ($kateqoriyalar as $kateqoriya)
                                            <option @if ($elan->kateqoriya_id == $kateqoriya->id) selected @endif
                                ...
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="seher_id">
                                        ...
                                        @foreach ($seherler as $seher)
                                            <option @if ($elan->seher_id == $seher->id) selected @endif
                            ...
                            <div class="col-md-6">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="yas_min">
                                        ...
                                        @for ($i = 18; $i <= 65; $i++)
                                            <option @if (explode('-',trim($elan->yas))[0] == $i) selected @endif
                                                value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @if ($errors)
                            ...
                            <div class="col-md-6">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="yas_max">
                                        ...
                                        @for ($i = 18; $i <= 65; $i++)
                                            <option @if (explode('-',trim($elan->yas))[1] == $i) selected @endif
                                                value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                    </select>
                                    @if ($errors)
                            ...
                            <div class="col-md-12">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="tehsil">
                                        ...
                                        <option @if ($elan->tehsil == 'Elmi Dərəcə') selected @endif value="Elmi Dərəcə">
                                            Elmi Dərəcə</option>
                                        <option @if ($elan->tehsil == 'Ali') selected @endif value="Ali">Ali
                                        </option>
                                        <option @if ($elan->tehsil == 'Natamam ali') selected @endif value="Natamam ali">
                                            Natamam ali</option>
                                        <option @if ($elan->tehsil == 'Orta texniki') selected @endif value="Orta texniki">
                                            Orta texniki</option>
                                        <option @if ($elan->tehsil == 'Orta xüsusi') selected @endif value="Orta xüsusi">
                                            Orta xüsusi</option>
                                        <option @if ($elan->tehsil == 'Orta') selected @endif value="Orta">Orta
                                        </option>
                                        <option @if ($elan->tehsil == 'Yoxdu') selected @endif value="Yoxdu">Yoxdu
                                        </option>
                                    </select>
                                    @if ($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="is_tecrubesi">
                                        <option @if ($elan->is_tecrubesi == 'none') selected @endif value="none">İş
                                            Təcrübəsi *</option>
                                        <option @if ($elan->is_tecrubesi == '1 ildən aşağı') selected @endif
                                            value="1 ildən aşağı">1 ildən aşağı </option>
                                        <option @if ($elan->is_tecrubesi == '1 ildən 3 ilə qədər') selected @endif
                                            value="1 ildən 3 ilə qədər">1 ildən 3 ilə qədər</option>
                                        <option @if ($elan->is_tecrubesi == '3 ildən 5 ilə qədər') selected @endif
                                            value="3 ildən 5 ilə qədər">3 ildən 5 ilə qədər</option>
                                        <option @if ($elan->is_tecrubesi == '5 ildən artıq') selected @endif
                            ...
                            <div class="col-md-4">
                                <div class="input_field">
                                    <input type="text" name="eh_min" id="min_eh"
                                        placeholder="Əməkhaqqı min (AZN)" value="@if($elan->emekhaqqi!="Ə/H razılaşma ilə"){{ explode('-',trim($elan->emekhaqqi))[0] }}@endif">
                                    @if ($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-4">
                                <div class="input_field">
                                    <input type="text" name="eh_max" id="max_eh"
                                        placeholder="Əməkhaqqı max (AZN)" value="@if($elan->emekhaqqi!="Ə/H razılaşma ilə"){{ explode('-',trim($elan->emekhaqqi))[1] }}@endif">
                                    @if ($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="is_melumat" id="" cols="30" rows="10" placeholder="İş barədə məlumat *">{{ $elan->is_melumat }}</textarea>
                                    @if ($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="is_teleb" id="" cols="30" rows="10" placeholder="Namizəddən tələblər *">{{ $elan->is_teleb }}</textarea>
                                    @if ($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="elave" id="" cols="30" rows="10" placeholder="Əlavə məlumat">{{ $elan->elave }}</textarea>
                                    {{-- @if ($errors)
                                        @foreach ($errors->all() as $error)
...
@if ($elan->emekhaqqi=="Ə/H razılaşma ilə")
    <script>
