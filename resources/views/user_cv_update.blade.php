                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input_field">
                                    <input type="text" name="ad" placeholder="Ad *" value="{{ $mutexessis->ad }}">
                                    @if($errors)
                            ...
                            <div class="col-md-4">
                                <div class="input_field">
                                    <input type="text" name="soyad" placeholder="Soyad *" value=" {{ $mutexessis->soyad }}">
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-4">
                                <div class="input_field">
                                    <input type="text" name="ata_adi" placeholder="Ata adı *" value="{{ $mutexessis->ata_adi}}">
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                                            @if (strtok($error, " ")=="Ata")
                                                <p style="color:red;font-size:12px" >{{$error}}</p>
                            ...
                            <div class="col-md-6">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="cins" >
                                        ...
                                        <option @if( $mutexessis->cins=="Kişi") selected @endif value="Kişi">Kişi</option>
                                        <option @if ($mutexessis->cins=="Qadın") selected @endif value="Qadın">Qadın</option>
                                    </select>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                                ...
                                <div class="single_input">
                                    <select class="wide select-box col-md-12" name="yas">
                                        <option selected value="none">Yaş *</option>
                                            @for ($i = 18; $i <= 65; $i++)
                                                <option  @if($mutexessis->yas==$i) selected @endif value="{{ $i }}">{{ $i }}</option>
                                            @endfor
                                    </select>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="tehsil">
                                        ...
                                        <option @if($mutexessis->tehsil=="Elmi Dərəcə") selected @endif  value="Elmi Dərəcə">Elmi Dərəcə</option>
                                        <option @if($mutexessis->tehsil=="Ali") selected @endif value="Ali">Ali</option>
                                        <option @if($mutexessis->tehsil=="Natamam ali") selected @endif  value="Natamam ali">Natamam ali</option>
                                        <option @if($mutexessis->tehsil=="Orta texniki") selected @endif value="Orta texniki">Orta texniki</option>
                                        <option @if($mutexessis->tehsil=="Orta xüsusi") selected @endif  value="Orta xüsusi">Orta xüsusi</option>
                                        <option @if($mutexessis->tehsil=="Orta") selected @endif  value="Orta">Orta</option>
                                        <option @if($mutexessis->tehsil=="Yoxdu") selected @endif  value="Yoxdu">Yoxdu</option>
                                    </select>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="tehsil_etrafli" id="" cols="30" rows="10" placeholder="Təhsil - Ətraflı">{{ $mutexessis->tehsil_etrafli }}</textarea>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="is_tecrubesi">
                                        <option @if($mutexessis->is_tecrubesi=="none") selected @endif  value="none">İş Təcrübəsi *</option>
                                        <option @if($mutexessis->is_tecrubesi=="1 ildən aşağı") selected @endif  value="1 ildən aşağı">1 ildən aşağı </option>
                                        <option @if($mutexessis->is_tecrubesi=="1 ildən 3 ilə qədər") selected @endif  value="1 ildən 3 ilə qədər">1 ildən 3 ilə qədər</option>
                                        <option @if($mutexessis->is_tecrubesi=="3 ildən 5 ilə qədər") selected @endif  value="3 ildən 5 ilə qədər">3 ildən 5 ilə qədər</option>
                                        <option @if($mutexessis->is_tecrubesi=="5 ildən artıq") selected @endif value="5 ildən artıq">5 ildən artıq</option>
                                    </select>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                                            @if (strtok($error, " ")=="İş")
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="is_tecrubesi_etrafli" id="" cols="30" rows="10" placeholder="İş təcrübəsi - Ətraflı">{{ $mutexessis->ish_tecrubesi_etrafli }}</textarea>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                                ...
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="kateqoriya_id">
                                        ...
                                        @foreach ($kateqoriyalar as $kateqoriya)
                                            <option @if($mutexessis->kateqoriya_id==$kateqoriya->id) selected @endif  value="{{ $kateqoriya->id }}">{{ $kateqoriya->ad }} </option>
                                        @endforeach                                   
                                    </select>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <input type="text" name="sahe" placeholder="Vəzifə *" value="{{ $mutexessis->sahe}}">
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                                ...
                                <div class="single_input" style="height: 70px">
                                    <select class="wide select-box col-md-12" name="seher_id">
                                        ...
                                        @foreach ($seherler as $seher)
                                            <option @if($mutexessis->seher_id==$seher->id) selected @endif value="{{ $seher->id }}">{{ $seher->ad }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="input_field">
                                    <input type="text" name="min_eh" placeholder="Minimum əməkhaqqı (AZN)" value="{{ $mutexessis->min_eh }}">
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="bacariqlar" id="" cols="30" rows="10" placeholder="Bacarıqlar *">{{ $mutexessis->bacariqlar}}</textarea>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-12">
                                <div class="input_field">
                                    <textarea name="elave_melumat" id="" cols="30" rows="10" placeholder="Əlavə məlumat">{{ $mutexessis->elave_melumat}}</textarea>
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-6">
                                <div class="input_field">
                                    <input type="text" name="telefon" placeholder="Telefon *" value="{{ $mutexessis->telefon }}">
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
                            ...
                            <div class="col-md-6">
                                <div class="input_field">
                                    <input type="text" name="email" placeholder="E-mail" value="{{ $mutexessis->email }}" >
                                    @if($errors)
                                        @foreach ($errors->all() as $error)
